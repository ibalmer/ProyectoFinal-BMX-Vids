...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 22-07-2025 a las 00:21:50
...
INSERT INTO `comment` (`id`, `user_id`, `post_id`, `content`, `publish_date`) VALUES
(39, 26, 167, 'vdfvsdfv', '2025-07-17 13:55:12'),
(45, 36, 180, 'que se repita!', '2025-07-17 19:49:03'),
(46, 26, 174, 'el co mentario\n', '2025-07-18 22:56:37'),
(47, 26, 151, 'hola\n', '2025-07-20 15:26:06'),
(48, 26, 184, 'aguante pele', '2025-07-20 16:02:03'),
(50, 22, 184, 'está más loco que una cabra 🐐', '2025-07-20 16:30:05'),
(51, 26, 184, 'hola hola\n', '2025-07-20 17:38:40'),
(52, 26, 180, 'alta jam', '2025-07-20 20:28:49');
...
(162, 'United \" Dont Matter \" ', '2007 united video', 'riders: corey martinez, nathan williams....', 'https://www.youtube.com/watch?v=KmATGRudZNU', 'street,2007,united', '2025-07-16 19:07:08', 'ivancito', 26, 1),
(163, 'Etnies Forward ', 'Etnies bmx Video ', 'Full parts from Mike \"Rooftop\" Escimilla, Jason Enns, Sandy Carson, Brian Terrada, Garrett Byrnes, Edwin Delarosa, Josh Stricker, Joe Rich, Nathan Wessel, Ian Morris, Dave Freimuth, Taj Mihelich, and Ruben Alcantara. Lots of other shredders in the mix section, filmed and edited by Dave Parrick.', 'https://www.youtube.com/watch?v=2poPndL51HU', 'etnies, 2002', '2025-07-16 19:08:02', 'ivancito', 26, 1),
...
(180, 'BMX - ENE ENE STREET JAM BUENOS AIRES ARGENTINA', '¿Estás seguro de que quieres eliminar este comentario?\nEsta acción es permanente.\n', '¿Estás seguro de que quieres eliminar este comentario?\nEsta acción es permanente.\n', 'https://www.youtube.com/watch?v=lUXPmySewXU', 'ivan,ene ene', '2025-07-17 13:54:08', 'ivancito', 26, 3),
(184, 'SAY LESS | Odyssey BMX', 'Corey Walsh, Gary Young, Dennis Enarson, Perris Benegas, Justin Spriet, Tom Dugan, and Noah Miranda. SAY LESS! Enjoy.\n\nVideo by Zach Krejmas\nArt by Dave Fortman\nPhotography by Scott Marceau\n', 'Corey Walsh, Gary Young, Dennis Enarson, Perris Benegas, Justin Spriet, Tom Dugan, and Noah Miranda. SAY LESS! Enjoy.\n\nVideo by Zach Krejmas\nArt by Dave Fortman\nPhotography by Scott Marceau\n', 'https://www.youtube.com/watch?v=NUpMUcnrHKw', 'odyssey,manu,agus', '2025-07-17 19:24:29', 'ivancito', 26, 2),
(185, 'Boyd Hilder vs. Dennis Enarson – El Juego de Bicicletas en el Parque – Videos del Viernes', 'Los videos del viernes de esta semana los presenta @sdwheelworks5761', 'Igual, pero diferente. El australiano Boyd Hilder se enfrenta a nuestro querido Dennis Enarson en una pelea cuerpo a cuerpo en el nuevo Claremont Skatepark. Puede que empiecen con buen pie, pero pronto empiezan a hacer trucos que saben que el otro no puede hacer, ¡y la cosa se pone fea! ¡No te lo querrás perder!', 'https://www.youtube.com/watch?v=mo5JkOxGRDw', 'game of bike', '2025-07-20 20:39:35', 'ivancito', 26, 2),
(186, 'RattyMaty -- Radius -- Profile Bmx', 'Originally posted in Collaboration with Dig Bmx.', 'Fufanu and abubaca fans rejoice! Ratty Maty is back  with an absolute stoker of a video for Profile, and he means business! \'Radius\' really highlights Maty\'s incredible ability to ride all sorts of transitions of all sizes and types— from ramps, to concrete DIY spots, dirt jumps, and everything in between. It\'s always refreshing to see lesser-seen stuff like switch bar-grabs, hurricanes, and a backside boneless make an appearance too. Enjoy!\n', 'https://www.youtube.com/watch?v=f1lhsbtfJAE', 'bici, profile', '2025-07-20 21:23:37', 'ivancito', 26, 2),
(187, 'BEST RUNS – SIMPLE  SESSION – BMX FINALS 2024', 'Doing it for Alex Hiam! As usual the BMX Finals ‪@simple-session‬2024 ', 'Doing it for Alex Hiam! As usual the BMX Finals ‪@simple-session‬2024 were insane (see above), but unfortunately they were also overshadowed by a bad crash that Alex Hiam took during qualifying. The Australian is currently stable and continues to be monitored closely in the ICU in the local hospital in Estonia. The prognosis for his recovery is positive.', 'https://www.youtube.com/watch?v=tJ59DSFcJg4', 'simple sesion, 2024', '2025-07-20 23:23:10', 'ivancito', 26, 3),
(188, 'INSANE FINALS! BATTLE OF HASTINGS 2022', 'Here we go, Battle of Hastings Finals is here...', 'Here we go, Battle of Hastings Finals is here, and it was INSANE. The culmination of all the weekend events landed us here with teams Varanyak, Dove, Reilly, Jones, and Perrin all battling it out for the win. \nThe format is: Four riders per team, two 50 second runs, and three attempts at a best trick. Teams are judged overall. Hit play and see who took the win...', 'https://www.youtube.com/watch?v=z9s798kkZss', 'finals, 2022', '2025-07-20 23:24:57', 'ivancito', 26, 3);
...
(1, 'ibalmer', 'Ivan', 'Balmer', '$2b$10$lkpZtDGO7X/qzvBtrBuc2.p672JcBZ.t60RV4bd6d0Gsy.znduZmy', 'ivan@balmersin.com', 'admin', NULL),
(21, 'cirqupipa', 'Leonardo', 'Garcia', '$2b$10$tK6beUAy03hUHY/oaTGStORGOQkXYcnVVUsvxHD8G3dZbPDRmSfe2', 'leonardo_garcia@ramon.com', 'admin', NULL),
(22, 'jesica', 'jesica', 'juarez', '$2b$10$PzLB7PwuxHLVHKWcoRCMm.qerUIfnlPcqyWhTgJysUy1NEC2Y0R6S', 'jesica@juarez.com', 'user', NULL),
(23, 'jesijesi', 'jesica', 'juarez', '$2b$10$k1ALweZHSJ4Qc0pOtUViv.fyhIaECbdHsS37YDKUx8.oOkJEYbbpW', 'jesi@hola.com', 'admin', NULL),
(24, 'el_balmer', 'ivan', 'balmer', '$2b$10$aXsJYwKWqGNCVDkcvanTYuBZiGFzZbHRDyv5BZ/FU5HrmqoJRm0be', 'ivan@prueba.com', 'user', NULL),
(25, 'el_leo_garcia', 'leonardo', 'garcia', '$2b$10$mvr40EWDenau/nprHagMTu.xvCN2gioFikOq.CSDQKUEmiHrrCRQe', 'le_leo@garcia.com', 'user', NULL),
(26, 'ivancito', 'ivan', 'balmer', '$2b$10$3yC/VCJlXP198sR49XJL5.xnJl0LSSUS6vRtlH/IdoZfv3aSmPKVy', 'ivan@cito.com', 'admin', '185,184,176,173'),
(27, 'pedrolin', 'pedro', 'pedro', '$2b$10$QsH4rvGKLoFZuq50QoETJOZclLNF.3Sr/Ebb3RycrbmMENP/ec30O', 'pedro@pedro.com', 'user', NULL),
(28, 'juancito', 'juan', 'cito', '$2b$10$JP4uy7F.peivXCX6CAPTFOhs016m/Pr.rhWaZuaB5/B9bbZMgLkNG', 'juan@cito.com', 'user', NULL),
(29, 'atendedor', 'atendedor', 'd\'boludos', '$2b$10$b4n1hE6ybah3sivtYiDKyu4Ji6s0jzJUoe2aXh.7IBMFk4DhrI9ce', 'atendedor@boludos.com', 'user', NULL),
(31, 'el leo 3d', 'leo', 'nardo', '$2b$10$BBbJrxMbvzWCAsuPvp8cJuYOVhR5fnRsJOJIXPbcWbKPyg0VQXzx.', 'leonardo_garcia@ramones.com', 'user', NULL),
(33, 'I_Balmer', 'ivan', 'bal', '$2b$10$Rmtnb876WRIGB5Krwe3LKupIwaoryeeRIyaEgXdOv5KRXxvjOKI4G', 'ivanbalmer28@hotmail.com', 'user', NULL),
(34, 'ibalmer2', 'ivan', 'bal', '$2b$10$rE7DbGsOKoD0AZcuZWElv.14afTPv2xjYWbsMHhc8I0NgTY9D648K', 'ivanbalmer29@hotmail.com', 'user', NULL),
(35, 'ibalmer2f', 'ivan', 'bal', '$2b$10$DZjpBCtyriO4wxgs4B6kV.sdeGlCphtd8W/d9eDcR3gL5jAwUz2we', 'ivanbalmevr29@hotmail.com', 'user', NULL),
(36, 'Claroscuro', 'Jesica', 'Juarez', '$2b$10$q70DwLe5ICj97KIxEApT9eru4MjDCKxCP9OdoWnCOELqy.ZR/efIu', 'clarita@doom.com', 'user', NULL);
